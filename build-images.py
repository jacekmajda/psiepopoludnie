...
SOURCES = [
    ...
    # Liczba w nazwie to proporcje kadru: po zmianie kadru trzeba ją
    # podbić, inaczej telefony pokazują stare zdjęcie z podręcznej pamięci
    ("1.jpeg", "collage-1-wide16", [480, 760, 1040], 1.6, 48),
